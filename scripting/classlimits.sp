...
{
	name        = "TF2C Class Restrictions",
	author      = "Clooooooooey",
	description = "Restrict classes in TF2C.",
	version     = PL_VERSION,
	url         = "no"
}
...
char g_sSounds[11][24] = {"", "vo/scout_no03.mp3",   "vo/sniper_no04.mp3", "vo/soldier_no01.mp3",
								...
								"vo/pyro_no01.mp3",    "vo/spy_no02.mp3",    "vo/engineer_no03.mp3", "vo/civilian_no3.mp3"};
...
public void OnPluginStart()
{
	...
	g_hLimits[TF_CLASS_CIVILIAN] 	=	CreateConVar("sm_classrestrict_civilian",	"-1",	"Limit for civilians in TF2.");
	g_hLimits[TF_CLASS_DEMOMAN] 	=	CreateConVar("sm_classrestrict_demoman",	"-1",	"Limit for demomen in TF2.");
	g_hLimits[TF_CLASS_ENGINEER] 	=	CreateConVar("sm_classrestrict_engineer",	"-1",	"Limit for engineers in TF2.");
	g_hLimits[TF_CLASS_HEAVY] 		=	CreateConVar("sm_classrestrict_heavy",		"-1",	"Limit for heavys in TF2.");
	g_hLimits[TF_CLASS_MEDIC] 		=	CreateConVar("sm_classrestrict_medic",		"-1",	"Limit for medics in TF2.");
	g_hLimits[TF_CLASS_PYRO] 		=	CreateConVar("sm_classrestrict_pyro",		"-1",	"Limit for pyros in TF2.");
	g_hLimits[TF_CLASS_SCOUT] 		=	CreateConVar("sm_classrestrict_scout",		"-1",	"Limit for scouts in TF2.");
	g_hLimits[TF_CLASS_SNIPER] 		=	CreateConVar("sm_classrestrict_sniper",		"-1",	"Limit for snipers in TF2.");
	g_hLimits[TF_CLASS_SOLDIER] 	=	CreateConVar("sm_classrestrict_soldier",	"-1",	"Limit for soldiers in TF2.");
	g_hLimits[TF_CLASS_SPY] 		=	CreateConVar("sm_classrestrict_spy",		"-1",	"Limit for spies in TF2.");
...
bool IsFull(int iTeam, int iClass)
{
	...
	int iLimit;
	float flLimit = g_hLimits[iClass].FloatValue;
